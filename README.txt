...
# Instructions for Attaching Elements to the Swipe Panel

1. Create your objects (they can be placed anywhere in the scene; the script will handle their position and hierarchy).
2. Add the created objects to the "Buffer List" of GameObjects in the VerticalScroll panel Inspector.
